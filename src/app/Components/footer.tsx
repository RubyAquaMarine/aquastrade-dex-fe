    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.column}>
        ...
        <ul>
          ...
          <li className={styles_list.navItem}>
            <Link href="https://github.com/RubyAquaMarine/aquastrade-sdk" target="_blank">
              SDK
            </Link>
          </li>
          ...
          <li className={styles_list.navItem}>
            <Link href="https://github.com/RubyAquaMarine/web3-bot" target="_blank">
              Web3 Bot
            </Link>
          </li>
          <li className={styles_list.navItem}>
            <Link href="https://github.com/RubyAquaMarine/razor-oracle-skale" target="_blank">
              Razor Oracle
            </Link>
          </li>
          {/* Add more links */}
